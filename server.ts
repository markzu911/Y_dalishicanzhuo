...
function buildPrompt(
  ...
  - REFERENCE IMAGE 2 (Table & Chairs Image): Replicate the exact marble tabletop pattern, colors, and premium chairs with 100% fidelity, adapting them to this specific high-angle diagonal looking-down perspective.`;
      perspectiveStyleRules = "Adopt a high-angle, top-down diagonal close-up perspective. The dining table must occupy the bottom-left and center of the frame, with its edge running diagonally from top-left/top-center to bottom-right. Beside and around the table, you MUST 100% faithfully replicate, restore, and display the exact dining chairs shown in Reference Image 2 (retaining their original materials, design details, color, and structure with absolute fidelity, with no replacements or changes to chair style). The chairs must be tucked neatly under the table, viewed from above. On the table, beautifully stage: (1) a tall glass vase containing delicate dried golden-white branches and leaves on the left, and (2) a dark rectangular serving tray with golden side handles holding two bottles of red wine and two elegant wine glasses in the middle. The polished marble surface must feature highly realistic glossy reflections of the room lighting and surrounding decor.";
    } else {
      // 中近景 (Medium Shot)
  ...
  - REFERENCE IMAGE 2 (Table & Chairs Image): Replicate the exact marble table and chairs with 100% fidelity, adapting them to the 45-degree high-angle medium shot, showcasing the tabletop surface from above.`;
    ...
    if (viewParam === "远景") {
      ...
      perspectiveStyleRules = "Adopt a high-angle, top-down diagonal close-up perspective. The dining table must occupy the bottom-left and center of the frame, with its edge running diagonally from top-left/top-center to bottom-right. Beside and around the table, you MUST 100% faithfully replicate, restore, and display the exact dining chairs shown in the REFERENCE IMAGE (retaining their original materials, design details, color, and structure with absolute fidelity, with no replacements or changes to chair style). The chairs must be tucked neatly under the table, viewed from above. On the table, beautifully stage: (1) a tall glass vase containing delicate dried golden-white branches and leaves on the left, and (2) a dark rectangular serving tray with golden side handles holding two bottles of red wine and two elegant wine glasses in the middle. The polished marble surface must feature highly realistic glossy reflections of the room lighting and surrounding decor.";
    } else {
      // 中近景 (Medium Shot)
...
${referenceExplanation}
  ...
  2. Table & Chairs Placement & 100% Faithful Restoration: You MUST 100% faithfully restore, replicate, and place BOTH the dining table and the dining chairs from the ${hasRoomImage ? "Reference Image 2" : "REFERENCE IMAGE"} into the designated dining area of the ${hasRoomImage ? "reconstructed" : "newly generated"} room. Do NOT change, omit, simplify, or replace the chairs' design, color, material, style, or structure, and do not change the table's shape, legs, base, or marble top. The table and chairs are a matching set and must be fully restored together as shown in the reference image. ${viewParam === "近景" ? "For this specific close-up view, the dining table must be placed diagonally, with its body dominating the bottom-left and center of the frame, and its long edge running diagonally from the top-left/top-center to the bottom-right, with the exact matching chairs from the reference image tucked neatly under the table, viewed from above." : "The dining table and chairs must be placed neatly and straight in relation to the room walls, but viewed from a 45-degree three-quarter high-angle camera perspective, looking down so that the beautiful marble tabletop surface is clearly visible from above, showcasing its polished patterns and reflections. All matching chairs from the reference image must be tucked in neatly and straight."} It must look seamlessly placed on the floor with physically accurate shadows (PBR), ambient occlusion, and lighting reflections matching the light sources of the room.
  ...
  4. Table & Chairs Details (Must be fully restored):
     ...
     - Chairs: Fully replicate and restore the exact matching chairs shown in the reference image with 100% fidelity. Do not replace or omit them.
